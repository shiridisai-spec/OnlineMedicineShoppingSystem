...
class UpdateMedicineComponent extends Component {
    ...
    componentDidMount()
    {
            ...
            MedicineService.getMedicineById(this.state.id).then( (res) =>{
                ...
                this.setState({medicineName: medicine.medicineName,
    ...
    updateMedicine = (m) => {
        ...
        let medicine = {medicineId:this.state.id,medicineName: this.state.medicineName, medicineBrand: this.state.medicineBrand, medicineprice:this.state.medicineprice
